...
**Plans**: TBD (planner sizes — likely 3 plans: Booli hardening / cron integration / launch + runbook)

Plans:
- [ ] 09-01: TBD (set during /gsd-plan-phase 9)
...
| 9. Production cutover — self-hosted scraper launch | v2.0 | 0/TBD | Not started | - |
