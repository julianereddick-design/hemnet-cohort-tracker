...
- [ ] 10-03 — cohort-track null-Booli threshold retarget. **Detailed plan written 2026-05-26: `.planning/phases/10-self-hosted-scraper-hardening/10-03-PLAN.md`** (self-contained, readable cold). NEEDS OPERATOR DECISION first: (a) age-bounded threshold, (b) week-over-week delta, (c) demote to reporting field. Exact code at `cohort-track.js:272-288`. Closes 09-04 #4 + supersedes the stale 09-03 #4 hypothesis.
