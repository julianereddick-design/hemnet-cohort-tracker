...
const JOBS = {
  ...
  'booli-targeted-refresh': {
    // Paused 2026-09-22 during the Booli App Router outage, restored the same day
    // once the flight-payload extractor was verified: a bounded --limit 25 rehearsal
    // fetched 25 / parsed 21 / 0 errors at a 16.0% inactive rate, inside the job's
    // own historical band (12.7-20.7% over the preceding month).
    tier: 1, frequency: 'every2days', label: 'Every 2 days (14:00)',
